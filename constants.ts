...
export const SKILLS: Skill[] = [
  { name: "Unity", desc: "Game Dev", bg: "bg-catUnity", value: 90, category: "Dev" },
  { name: "React", desc: "Frontend", bg: "bg-catWeb", value: 85, category: "Dev" },
  { name: "TypeScript", desc: "Logic", bg: "bg-blue-200", value: 80, category: "Dev" },
  { name: "Blender", desc: "3D Art", bg: "bg-cat3D", value: 70, category: "Art" },
  { name: "SwiftUI", desc: "Mobile", bg: "bg-catApp", value: 65, category: "Dev" },
