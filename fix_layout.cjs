...
// The file has duplicated sections because of my bad replace.
// I will just slice from 0 to the FIRST {/* --- WORK SECTION --- */}
const startIdx = text.indexOf('{/* --- WORK SECTION --- */}');

// And slice from the LAST {/* --- NOTEBOOK SECTION --- */} to the end
const endIdx = text.lastIndexOf('{/* --- NOTEBOOK SECTION --- */}');
...
text = text.substring(0, startIdx) + newWorkSection + text.substring(endIdx);
